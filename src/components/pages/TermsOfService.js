  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <Typography variant="h4">5. Revisions and Errata</Typography>
        ...
        <Typography variant="h4">7. Site Terms of Use Modifications</Typography>
        ...
        <Typography variant="h4">8. Your Privacy</Typography>
