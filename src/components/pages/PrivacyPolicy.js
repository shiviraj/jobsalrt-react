  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <Typography variant="h3">Privacy Policy for Jobs Alrt</Typography>

        <Typography variant="body1">
          At Jobs Alrt, accessible from https://www.jobsalrt.com/, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Jobs Alrt and how we use it.
        </Typography>
        ...
        <Typography variant="body1">
          ...
          shared and/or collect in Jobs Alrt. This policy is not applicable to
        ...
        <Typography variant="body1">
          Jobs Alrt follows a standard procedure of using log files. These files
        ...
        <Typography variant="body1">
          Like any other website, Jobs Alrt uses 'cookies'. These cookies are
        ...
        <Typography variant="body1">
          ...
          advertising partners of Jobs Alrt.
        </Typography>

        <Typography variant="body1">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Jobs Alrt, which are sent
        ...
        <Typography variant="body1">
          Note that Jobs Alrt has no access to or control over these cookies
        ...
        <Typography variant="body1">
          Jobs Alrt's Privacy Policy does not apply to other advertisers or
          websites. Thus, we are advising you to consListt the respective
        ...
        <Typography variant="body1">
          Jobs Alrt does not knowingly collect any Personal Identifiable
