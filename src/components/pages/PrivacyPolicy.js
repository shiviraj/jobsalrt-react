...
const PrivacyPolicy = () => {
  return (
    <PageLayout>
      <h1>Privacy Policy for Jobs Alrt</h1>

      <p>
        At Jobs Alrt, accessible from https://www.jobsalrt.com/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Jobs
        Alrt and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Jobs Alrt. This policy is not applicable to any
      ...
      <p>
        Like any other website, Jobs Alrt uses 'cookies'. These cookies are used
      ...
      <p>
        Note that Jobs Alrt has no access to or control over these cookies that
