  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <Typography variant="h4">About JobsAlrt</Typography>
        <Typography>
        ...
        <Typography variant="h4">About Admin</Typography>
        <Typography>
          ...
          than 14 countries. I completed my Diploma in Electronics Engineering
          at Government Polytechnic Luknow. I am pursuing BCA at Algappa
          University in Tamilnadu.
        </Typography>
